...
const Navbar7 = (props) => {
  ...
  return (
    <div className="navbar7-container">
      <header data-thq="thq-navbar" className="navbar7-navbar-interactive">
        ...
        {link5DropdownVisible && (
          <div className="navbar7-container1 thq-box-shadow">
            <div className="navbar7-menu-item">
              <img
                alt={props.page1ImageAlt}
                src={props.page1ImageSrc}
                className="navbar7-page1-image"
              />
          ...
          <nav className="navbar7-links">
            ...
            >
              ...
              <div className="navbar7-icon-container">
                {link5DropdownVisible && (
                  <div className="navbar7-container2">
...
Navbar7.defaultProps = {
  ...
  link5: 'Link5',
  page4Description: 'Lorem ipsum dolor sit amet consectetur elit',
  ...
  logoAlt: 'logo',
  page2: 'Page Two',
  page3Description: 'Lorem ipsum dolor sit amet consectetur elit',
  page2Description: 'Lorem ipsum dolor sit amet consectetur elit',
  logoSrc:
  ...
  page1Description: 'Lorem ipsum dolor sit amet consectetur elit',
  page3ImageAlt: 'image',
  page4ImageAlt: 'image',
  link1: 'Link1',
}
